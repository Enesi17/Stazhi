    ...
    <div id='menu'>
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ml-auto">
          ...
          { !currentUser && <li className="nav-item"><a className="nav-link" href="/signup">Create Account</a></li>}
          <li className="nav-item">
            { !currentUser && <a className="nav-link" href="/">Dashboard</a>}
            { currentUser && <a className="nav-link" href="/dashboard">Dashboard</a>}
          </li>
